...
public class InformationActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView01.loadUrl("http://saju.oursoccer.co.kr/webview/inform/user");

        gcmEndMessage = new GcmEndMessage();
        gcmEndMessage.gcmEndMessage(cookieStore.getCookies().get(0).getValue(),getSharedPreferences("Gcm_end_message", MODE_PRIVATE), InformationActivity.this);
    ...
    protected void onNewIntent(final Intent intent) {
        ...
        gcmEndMessage.isSimpleHistory(cookieStore.getCookies().get(0).getValue(),broadcast_history_no, sender_name,select_history, InformationActivity.this);
    }
